...
public class StudyPage {
	...
	private static StudyPage studyMain;
	...
	public static StudyPage getInstance() {
		if (studyMain == null) {
			studyMain = new StudyPage();
		}
		return studyMain;
	}
	...
	public void modifyComment() {
		...
		if (cv2.getMemberID() == memberID || myAccount.getMemberID().startsWith("MASTER")) { // 댓글번호와 ID가 일치하는 댓글이 존재할 경우 + 관리자
